...
INSERT INTO `device_types` VALUES ('14','VIDI Open Close'),('16','VIDI Flow'),('17','VIDI Pressure'),('18','VIDI Temp'),('23','VIDI Level'),('24','VIDI Positioner'),('28','VIDI PRV Controller'),('29','VIDI Positioner with ext. antenna'),('31','VIDI Leak'),('32','VIDI Positioner 2.0'),('33','VIDI Weather Shield');
